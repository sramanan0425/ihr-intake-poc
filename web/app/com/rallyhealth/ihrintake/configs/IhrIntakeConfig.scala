...
case class IhrIntakeConfig(
                           rallyConfig: RallyConfig,
                           secretConfig: SecretConfig) {

  lazy val loggingSecureEnabled: Boolean = rallyConfig.get("ihrintake.secure.logging.secureenabled", "false").toString.toBoolean
  lazy val loggingSecureLinkEnabled: Boolean = rallyConfig.get("ihrintake.secure.logging.securelinkenabled", "false").toString.toBoolean
  lazy val loggingEncryptKey: String = secretConfig.get("ihrintake.secure.logging.encryptkey", Defaults.loggingEncryptKey)
  lazy val playSecret: String = secretConfig.get("ihrintake.play.secret", Defaults.playSecret)
  lazy val rqStatsPrefix: String = rallyConfig.get("ihrintake.rqstats.prefix", "dataship")
  lazy val oauthClientId: String = secretConfig.get("ihrintake.optum.oauth.client.id", Defaults.oauthClientId)
  lazy val oauthClientSecret: String = secretConfig.get("ihrintake.optum.oauth.client.secret", Defaults.oauthClientSecret)
  lazy val serviceEncryptKey: SecretValue = secretConfig.get("ihrintake.encrypt.key.service", Defaults.defaultKeyValue)
...
object IhrIntakeConfig {
  ...
  val serviceName: String = "IhrIntake"
}

package com.rallyhealth.ihrintake.util
...
/**
  ...
  */
trait IhrIntakeStats {

  protected val stats: Stats = KeyPrefixedStats(Stats, "ihrintake")
...
object StatsConstants {
  val centrIhrService = Seq("centrIhrService")
}
